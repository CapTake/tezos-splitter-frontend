            ...
            <div v-for="(item, index) in holders" :key="item.address + index" class="my-4">
                <div class="flex gap-3">
                    <div class="relative grow">
                        ...
                        <input v-model.trim="item.address" @focus="$event => onInputFocus($event)" @blur="$event => validateItem(item)" type="text" class=" text-ellipsis bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="address or tezos domain">
                    </div>
                    <div class="shrink">
